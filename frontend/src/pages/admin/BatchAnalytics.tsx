// frontend/src/pages/admin/BatchAnalytics.tsx
...
const AdminBatchAnalytics: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Batch Analytics Dashboard</h1>
          <p className="text-gray-600">Comprehensive insights into batch performance and student progress</p>
        </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-semibold text-gray-900">{analytics.attendance.totalRecords}</span>
                  </div>
                </div>
              </div>
