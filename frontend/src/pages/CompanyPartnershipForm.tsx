...
const CompanyPartnershipForm: React.FC = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.mobile.trim()) {
      ...
      if (!phoneRegex.test(formData.mobile)) {
        newErrors.mobile = `Mobile number must be exactly ${requiredLength} digits for ${selectedCountry?.country}`;
      }
    }
  ...
  const handlePhoneChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (value.length <= maxLength) {
      ...
      if (value.length > 0 && value.length < maxLength) {
        setErrors(prev => ({ ...prev, mobile: `Mobile number must be exactly ${maxLength} digits for ${selectedCountry?.country}` }));
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("https://rass1.onrender.com/api/company-partnership", {
        method: "POST",
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50 p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-8">
            Your partnership inquiry has been submitted successfully. Our team will review your information and get back to you within 2-3 business days.
          </p>
  ...
  return (
    <div>
    <SEO {...pageSEOConfig.companyPartnership} />
    <Navbar />
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Company Partnership Form
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Partner with us to access skilled talent and accelerate your hiring process. Fill out the form below and our team will get in touch with you.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <select
                      ...
                      onChange={(e) => {
                        setFormData({ ...formData, countryCode: e.target.value, mobile: '' });
                        setErrors(prev => ({ ...prev, mobile: '' }));
                      }}
                    ...
                    <div className="flex-1 relative">
                      ...
                      <input
                        ...
                        className={`block w-full pl-10 pr-3 py-3 border ${errors.mobile ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-indigo-500 focus:border-indigo-500`}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`block w-full pl-10 pr-3 py-3 border ${errors.organization ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-indigo-500 focus:border-indigo-500`}
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Tell us about your partnership requirements and how we can help your organization..."
              ></textarea>
...
export default CompanyPartnershipForm;